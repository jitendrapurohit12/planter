...
String emailValidator(String key, String value) => value.isNotEmpty ? null : errorGeneric(key);

String notMandatoryEmailValidator(String key, String value) =>
    (value.isEmpty || RegExp(kRegexEmail).hasMatch(value)) ? null : errorGeneric(key);

String passwordValidator(String key, String value) =>
    value.trim().isNotEmpty && value.length >= 6 ? null : errorInvalidPassword(key);
